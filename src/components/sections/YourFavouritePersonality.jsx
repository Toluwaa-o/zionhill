...
const YourFavouritePersonality = memo(() => {
  ...
  const [personality] = useState([
    {
      image: generateImgPath("/public/assets/images/cast/01.webp"),
      title: "ott_home.john_abraham",
      category: "detail_page.actor",
    },
    {
      image: generateImgPath("/public/assets/images/cast/02.webp"),
      title: "ott_home.leena_burton",
      category: "ott_home.actress",
    },
    {
      image: generateImgPath("/public/assets/images/cast/03.webp"),
      title: "ott_home.lorina_williams",
      category: "ott_home.actress",
    },
    {
      image: generateImgPath("/public/assets/images/cast/04.webp"),
      title: "ott_home.davina_decorous",
      category: "ott_home.actress",
    },
    {
      image: generateImgPath("/public/assets/images/cast/05.webp"),
      title: "ott_home.thomas_bailey",
      category: "ott_home.producer",
    },
    {
      image: generateImgPath("/public/assets/images/cast/06.webp"),
      title: "ott_home.kelly_reilly",
      category: "ott_home.actress",
    },
    {
      image: generateImgPath("/public/assets/images/cast/07.webp"),
      title: "ott_home.smith_jonas",
      category: "ott_home.director",
    },
    {
      image: generateImgPath("/public/assets/images/cast/08.webp"),
      title: "ott_home.angel_louis",
      category: "ott_home.producer",
    },
    {
      image: generateImgPath("/public/assets/images/cast/09.webp"),
      title: "ott_home.millar_joseph",
      category: "detail_page.actor",
    },
    {
      image: generateImgPath("/public/assets/images/cast/10.webp"),
      title: "ott_home.mark_wilson",
      category: "detail_page.actor",
    },
    {
      image: generateImgPath("/public/assets/images/cast/11.webp"),
      title: "ott_home.kelley_walker",
      category: "ott_home.producer",
    },
    {
      image: generateImgPath("/public/assets/images/cast/12.webp"),
