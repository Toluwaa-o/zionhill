...
const CastViewAll = memo(() => {
  ...
  const cast = [
    {
      id: "01",
      thumbnail: "/public/assets/images/cast/01.webp",
      name: "ott_home.john_abraham",
      category: "detail_page.actor",
    },
    {
      id: "02",
      thumbnail: "/public/assets/images/cast/02.webp",
      name: "ott_home.leena_burton",
      category: "detail_page.Actress",
    },
    {
      id: "03",
      thumbnail: "/public/assets/images/cast/03.webp",
      name: "ott_home.lorina_williams",
      category: "detail_page.actor",
    },
    {
      id: "04",
      thumbnail: "/public/assets/images/cast/04.webp",
      name: "ott_home.davina_decorous",
      category: "detail_page.Actress",
    },
    {
      id: "05",
      thumbnail: "/public/assets/images/cast/05.webp",
      name: "ott_home.thomas_bailey",
      category: "detail_page.Producer",
    },
    {
      id: "06",
      thumbnail: "/public/assets/images/cast/06.webp",
      name: "ott_home.kelly_reilly",
      category: "detail_page.Actress",
    },
    {
      id: "07",
      thumbnail: "/public/assets/images/cast/07.webp",
      name: "ott_home.smith_jonas",
      category: "detail_page.Director",
    },
    {
      id: "08",
      thumbnail: "/public/assets/images/cast/08.webp",
      name: "ott_home.angel_louis",
      category: "detail_page.Producer",
    },
    {
      id: "09",
      thumbnail: "/public/assets/images/cast/09.webp",
      name: "ott_home.millar_joseph",
      category: "detail_page.actor",
    },
    {
      id: "10",
      thumbnail: "/public/assets/images/cast/10.webp",
      name: "ott_home.mark_wilson",
      category: "detail_page.actor",
    },
    {
      id: "11",
      thumbnail: "/public/assets/images/cast/11.webp",
      name: "ott_home.kelley_walker",
      category: "detail_page.Director",
    },
    {
      id: "12",
      thumbnail: "/public/assets/images/cast/12.webp",
